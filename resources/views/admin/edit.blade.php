...
@csrf
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" name="admin_name" value="{{$res->admin_name}}" class="form-control" id="firstname" 
				   placeholder="请输入名字">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" name="admin_email" value="{{$res->admin_email}}" class="form-control" id="firstname" 
				   placeholder="请输入名字">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" name="admin_pwd" value="{{$res->admin_pwd}}" class="form-control" id="firstname" 
				   placeholder="请输入名字">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="password" name="admin_pwd" value="{{$res->admin_pwd}}" class="form-control" id="firstname" 
				   placeholder="请输入名字">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="file" name="admin_logo" class="form-control" id="firstname" 
                ...
                <img src="{{env('UPLOADS_URL')}}{{$res->admin_logo}}" with="60" height="60">
		</div>
	</div>
	<div class="form-group">
